...
Material::~Material(void)
{
	...
	delete m_shaderProgram.fragment;
	delete m_shaderProgram.vertex;
}
...
void Material::SendUniform(const char* name, std::vector<Matrix4> data)
{
	int location = OpenGLRenderer::GetUniformLocation( m_shaderProgram.programID , name);
	OpenGLRenderer::SetUniform( location , data);
}
...
void Material::Activate()
{
	...
	if (diffuseMapUniformLocation != -1)
