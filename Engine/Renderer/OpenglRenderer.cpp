...
int OpenGLRenderer::VERTEX_SHADER;
int OpenGLRenderer::FRAGMENT_SHADER;
int OpenGLRenderer::LINK_STATUS;
int OpenGLRenderer::SHAPE_QUADS;
int OpenGLRenderer::SHAPE_LINES;
int OpenGLRenderer::SHAPE_POINTS;
int OpenGLRenderer::VERSION;
int OpenGLRenderer::SHADING_LANGUAGE_VERSION;
int OpenGLRenderer::ONE_MINUS_DESTINATION_COLOR;
int OpenGLRenderer::ZERO;					
int OpenGLRenderer::SRC_ALPHA;				
int OpenGLRenderer::ONE_MINUS_SRC_ALPHA;
int OpenGLRenderer::ONE;
int OpenGLRenderer::SHAPE_TRIANGLES;
int OpenGLRenderer::SHAPE_LINE_LOOP;
...
Material* OpenGLRenderer::DEFAULT_MATERIAL;
Material* OpenGLRenderer::FBO_MATERIAL;
...
void OpenGLRenderer::BlendMode(int blendSource, int blendDestination)
{
...
void OpenGLRenderer::DrawVertexWithVertexArray(Vertex_PosColor* vertices,int sizeOfVertices,int glDrawMode)
{
...
void OpenGLRenderer::DrawVertexWithVertexBufferObject(int vboID, int numOfVertices, int glDrawMode, Vertex_PosColor)
{
	glDisable(GL_TEXTURE_2D);
...
void OpenGLRenderer::DrawVertexWithIndexedVertexBufferObject(int vboID, int iboID, int numOfVertices, int numOfIndices, int glDrawMode, Vertex_PCTN)
{
	...
	//glDrawArrays( glDrawMode , 0, numOfVertices );
	glDrawElements(glDrawMode, numOfIndices, GL_UNSIGNED_INT, (void*)0);
...
void OpenGLRenderer::DrawVertexWithIndexedVertexBufferObject(int vboID, int iboID, int numOfVertices, int numOfIndices, int glDrawMode, Vertex_PCTNB)
{
	UNUSED(numOfVertices);
	// MAX ATTRIBUTES YOU CAN SEND IS 16
	...
	int biTangentID		= glGetAttribLocation(SHADER_PROGRAM_ID, "a_biTangent");
	int normalID		= glGetAttribLocation(SHADER_PROGRAM_ID, "a_normal");
	int boneId0ID		= glGetAttribLocation(SHADER_PROGRAM_ID, "a_boneId0");
	int boneId1ID		= glGetAttribLocation(SHADER_PROGRAM_ID, "a_boneId1");
	int boneId2ID		= glGetAttribLocation(SHADER_PROGRAM_ID, "a_boneId2");
	int boneId3ID		= glGetAttribLocation(SHADER_PROGRAM_ID, "a_boneId3");
	int boneId4ID		= glGetAttribLocation(SHADER_PROGRAM_ID, "a_boneId4");
	int boneId5ID		= glGetAttribLocation(SHADER_PROGRAM_ID, "a_boneId5");
	int boneId6ID		= glGetAttribLocation(SHADER_PROGRAM_ID, "a_boneId6");
	int boneId7ID		= glGetAttribLocation(SHADER_PROGRAM_ID, "a_boneId7");
	int boneWeights0ID	= glGetAttribLocation(SHADER_PROGRAM_ID, "a_boneWeights0");
	int boneWeights1ID	= glGetAttribLocation(SHADER_PROGRAM_ID, "a_boneWeights1");
	
	glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, iboID);
	glBindBuffer(GL_ARRAY_BUFFER, vboID);

	// FIX: should check if Location is -1 before Enable it.
	glEnableVertexAttribArray(vertexArrayID);
	glEnableVertexAttribArray(colorArrayID);
	glEnableVertexAttribArray(texArrayID);
	glEnableVertexAttribArray(tangentID);
	glEnableVertexAttribArray(biTangentID);
	glEnableVertexAttribArray(normalID);
	glEnableVertexAttribArray(boneId0ID);
	glEnableVertexAttribArray(boneId1ID);
	glEnableVertexAttribArray(boneId2ID);
	glEnableVertexAttribArray(boneId3ID);
	glEnableVertexAttribArray(boneId4ID);
	glEnableVertexAttribArray(boneId5ID);
	glEnableVertexAttribArray(boneId6ID);
	glEnableVertexAttribArray(boneId7ID);
	glEnableVertexAttribArray(boneWeights0ID);
	glEnableVertexAttribArray(boneWeights1ID);
	
	glVertexAttribPointer(vertexArrayID, 3, GL_FLOAT, false, sizeof(Vertex_PCTNB), (const GLvoid*)offsetof(Vertex_PCTNB, position));
	glVertexAttribPointer(colorArrayID, 4, GL_UNSIGNED_BYTE, true, sizeof(Vertex_PCTNB), (const GLvoid*)offsetof(Vertex_PCTNB, color));
	glVertexAttribPointer(texArrayID, 2, GL_FLOAT, false, sizeof(Vertex_PCTNB), (const GLvoid*)offsetof(Vertex_PCTNB, texCoords));
	glVertexAttribPointer(tangentID, 3, GL_FLOAT, false, sizeof(Vertex_PCTNB), (const GLvoid*)offsetof(Vertex_PCTNB, normals.tangent));
	glVertexAttribPointer(biTangentID, 3, GL_FLOAT, false, sizeof(Vertex_PCTNB), (const GLvoid*)offsetof(Vertex_PCTNB, normals.biTangent));
	glVertexAttribPointer(normalID, 3, GL_FLOAT, false, sizeof(Vertex_PCTNB), (const GLvoid*)offsetof(Vertex_PCTNB, normals.normal));
	glVertexAttribIPointer(boneId0ID, 1, GL_INT, sizeof(Vertex_PCTNB), (const GLvoid*)offsetof(Vertex_PCTNB, boneIdWeights.ids[0]));
	glVertexAttribIPointer(boneId1ID, 1, GL_INT, sizeof(Vertex_PCTNB), (const GLvoid*)offsetof(Vertex_PCTNB, boneIdWeights.ids[1]));
	glVertexAttribIPointer(boneId2ID, 1, GL_INT, sizeof(Vertex_PCTNB), (const GLvoid*)offsetof(Vertex_PCTNB, boneIdWeights.ids[2]));
	glVertexAttribIPointer(boneId3ID, 1, GL_INT, sizeof(Vertex_PCTNB), (const GLvoid*)offsetof(Vertex_PCTNB, boneIdWeights.ids[3]));
	glVertexAttribIPointer(boneId4ID, 1, GL_INT, sizeof(Vertex_PCTNB), (const GLvoid*)offsetof(Vertex_PCTNB, boneIdWeights.ids[4]));
	glVertexAttribIPointer(boneId5ID, 1, GL_INT, sizeof(Vertex_PCTNB), (const GLvoid*)offsetof(Vertex_PCTNB, boneIdWeights.ids[5]));
	glVertexAttribIPointer(boneId6ID, 1, GL_INT, sizeof(Vertex_PCTNB), (const GLvoid*)offsetof(Vertex_PCTNB, boneIdWeights.ids[6]));
	glVertexAttribIPointer(boneId7ID, 1, GL_INT, sizeof(Vertex_PCTNB), (const GLvoid*)offsetof(Vertex_PCTNB, boneIdWeights.ids[7]));
	glVertexAttribPointer(boneWeights0ID, 4, GL_FLOAT, false, sizeof(Vertex_PCTNB), (const GLvoid*)offsetof(Vertex_PCTNB, boneIdWeights.weights[0]));
	glVertexAttribPointer(boneWeights1ID, 4, GL_FLOAT, false, sizeof(Vertex_PCTNB), (const GLvoid*)offsetof(Vertex_PCTNB, boneIdWeights.weights[4]));
	...
	glDisableVertexAttribArray(biTangentID);
	glDisableVertexAttribArray(normalID);
	glDisableVertexAttribArray(boneId0ID);
	glDisableVertexAttribArray(boneId1ID);
	glDisableVertexAttribArray(boneId2ID);
	glDisableVertexAttribArray(boneId3ID);
	glDisableVertexAttribArray(boneId4ID);
	glDisableVertexAttribArray(boneId5ID);
	glDisableVertexAttribArray(boneId6ID);
	glDisableVertexAttribArray(boneId7ID);
	glDisableVertexAttribArray(boneWeights0ID);
	glDisableVertexAttribArray(boneWeights1ID);
...
void OpenGLRenderer::DrawVertexWithIndexedVertexBufferObject(int vboID, int iboID, int numOfVertices, int numOfIndices, int glDrawMode, Vertex_PosColor)
{
	UNUSED(numOfVertices);
	...
	//glDrawArrays(glDrawMode, 0, numOfIndices);
	glDrawElements(glDrawMode, numOfIndices, GL_UNSIGNED_INT, (void*)0);
...
void OpenGLRenderer::DrawVertexWithVertexBufferObject(int vboID, int numOfVertices, int glDrawMode, Vertex_PCTN)
{
	int vertexArrayID = glGetAttribLocation(SHADER_PROGRAM_ID,"a_position");
	int colorArrayID = glGetAttribLocation(SHADER_PROGRAM_ID,"a_color");
	int texArrayID = glGetAttribLocation(SHADER_PROGRAM_ID,"a_textureCoords");
...
void OpenGLRenderer::DrawVertexWithVertexArray(Vertex_PCT* vertices, int sizeOfVertices, int glDrawMode)
{
	glEnable(GL_TEXTURE_2D);
...
void OpenGLRenderer::DrawVertexWithVertexArray(std::vector<Vertex_PosColor>& vertices, int glDrawMode)
{
	if (vertices.size() == 0)
		return;
...
void OpenGLRenderer::DrawVertexWithVertexArray(std::vector<Vertex_PCTNB>& vertices, int glDrawMode)
{
	glEnable(GL_TEXTURE_2D);
	...
	int biTangentID = glGetAttribLocation(SHADER_PROGRAM_ID, "a_biTangent");
	int normalID = glGetAttribLocation(SHADER_PROGRAM_ID, "a_normal");
	int boneIdsID = glGetAttribLocation(SHADER_PROGRAM_ID, "a_boneIds");
	int boneWeightsID = glGetAttribLocation(SHADER_PROGRAM_ID, "a_boneWeights");
	...
	glEnableVertexAttribArray(biTangentID);
	glEnableVertexAttribArray(normalID);
	glEnableVertexAttribArray(boneIdsID);
	glEnableVertexAttribArray(boneWeightsID);

	glVertexAttribPointer(vertexArrayID, 3, GL_FLOAT, false, sizeof(Vertex_PCTNB), &vertices[0].position);
	glVertexAttribPointer(colorArrayID, 4, GL_UNSIGNED_BYTE, true, sizeof(Vertex_PCTNB), &vertices[0].color);
	glVertexAttribPointer(texArrayID, 2, GL_FLOAT, false, sizeof(Vertex_PCTNB), &vertices[0].texCoords);
	glVertexAttribPointer(tangentID, 3, GL_FLOAT, false, sizeof(Vertex_PCTNB), &vertices[0].normals.tangent);
	glVertexAttribPointer(biTangentID, 3, GL_FLOAT, false, sizeof(Vertex_PCTNB), &vertices[0].normals.biTangent);
	glVertexAttribPointer(normalID, 3, GL_FLOAT, false, sizeof(Vertex_PCTNB), &vertices[0].normals.normal);
	glVertexAttribPointer(boneIdsID, MAX_BONE_ATTACH_SUPPORT, GL_INT, false, sizeof(Vertex_PCTNB), &vertices[0].boneIdWeights.ids[0]);
	glVertexAttribPointer(boneWeightsID, MAX_BONE_ATTACH_SUPPORT, GL_FLOAT, false, sizeof(Vertex_PCTNB), &vertices[0].boneIdWeights.weights[0]);
	...
	glDisableVertexAttribArray(biTangentID);
	glDisableVertexAttribArray(normalID);
	glDisableVertexAttribArray(boneIdsID);
	glDisableVertexAttribArray(boneWeightsID);

	glDisable(GL_TEXTURE_2D);
}


void OpenGLRenderer::DrawVertexWithVertexArray(std::vector<Vertex_PCT>& vertices, int glDrawMode)
{
	if(vertices.size() == 0)
		return;
...
void OpenGLRenderer::DrawVertexWithVertexArray(Vertex_PCTN* vertices, int sizeOfVertices, int glDrawMode)
{
	glEnable(GL_TEXTURE_2D);
...
void OpenGLRenderer::DrawVertexWithVertexArray(std::vector<Vertex_PCTN>& vertices, int glDrawMode)
{
	glEnable(GL_TEXTURE_2D);
...
void OpenGLRenderer::GetProgramIV(GLuint programID, int name, bool &wasSuccessful)
{
	GLint success;
	...
	else
	{
		...
		delete[] infoLogText;
		infoLogString += "The program will close now.";	//FIX: error message with file name.
...
std::string OpenGLRenderer::GetString(int variable)
{
...
void OpenGLRenderer::SetUniform(int uniformLocation, std::vector<Matrix4> matrixs)
{
	glUniformMatrix4fv(uniformLocation, matrixs.size(), false, matrixs[0].m_matrix);
}
...
void OpenGLRenderer::DrawElements(std::vector<GLfloat> vertices, std::vector<GLfloat> normals, std::vector<GLfloat> texCoords, std::vector<GLshort> indices, int drawMode)
{
	glEnable(GL_TEXTURE_2D);
...
void OpenGLRenderer::DrawVertexWithVertexArray2D(Vertex_PosColor* vertices, int sizeOfVertices, int glDrawMode, float width, float height)
{
	glDisable(GL_TEXTURE_2D);
	glDisable(GL_DEPTH_TEST);
	PushMatrix();
...
void OpenGLRenderer::DrawVertexWithVertexArray2D(Vertex_PCT* vertices, int sizeOfVertices, int glDrawMode, float width, float height)
{
...
void OpenGLRenderer::DrawVertexWithVertexArray2D(std::vector<Vertex_PCT>& vertices, int glDrawMode, float width, float height)
{
	if(vertices.size() == 0)
		return;
...
void OpenGLRenderer::DrawVertexWithVertexArray2D(std::vector<Vertex_PosColor>& vertices, int glDrawMode, float width, float height)
{
	if (vertices.size() == 0)
		return;
...
void OpenGLRenderer::BufferData(std::vector<Vertex_PCTNB>& vertices, int vboID)
{
	glBindBuffer(GL_ARRAY_BUFFER, vboID);
	glBufferData(GL_ARRAY_BUFFER, sizeof(Vertex_PCTNB) * vertices.size(), vertices.data(), GL_STATIC_DRAW);
	glBindBuffer(GL_ARRAY_BUFFER, 0);
}
...
void OpenGLRenderer::BufferData(std::vector<unsigned int>& indices, int iboID)
{
	glBindBuffer( GL_ELEMENT_ARRAY_BUFFER, iboID );
...
void OpenGLRenderer::CreateDefaultMaterial()
{
	...
	default_sp.programID = CreateProgram();
	std::string default_fragment_source = "#version 130\n"; 
	default_fragment_source += "in vec4 v_color;\n";
	default_fragment_source += "out vec4 fragment_color;\n";
	default_fragment_source += "void main(void)\n";
	default_fragment_source += "{\n";
	default_fragment_source += "fragment_color = v_color;\n";
	default_fragment_source += "}\n";
	
	std::string default_vertex_source = "#version 130\n";
	default_vertex_source += "in vec3 a_position;\n";
	default_vertex_source += "in vec4 a_color;\n";
	default_vertex_source += "out vec4 v_color;\n";
	default_vertex_source += "uniform mat4 u_worldToClipMatrix;\n";
	default_vertex_source += "uniform mat4 u_objectToWorldMatrix;\n";
	default_vertex_source += "void main(void)\n";
	default_vertex_source += "{\n";
	default_vertex_source += "v_color = a_color;\n";
	default_vertex_source += "gl_Position = u_worldToClipMatrix * u_objectToWorldMatrix * vec4(a_position,1.0);\n";
	default_vertex_source += "}\n";

	default_sp.fragment = new OpenGLShader(FRAGMENT_SHADER, default_fragment_source.c_str());
	default_sp.vertex = new OpenGLShader(VERTEX_SHADER, default_vertex_source.c_str());

	DEFAULT_MATERIAL = new Material(default_sp);

	ShaderProgram fbo_sp;
	fbo_sp.programID = CreateProgram();
	std::string fbo_fragment_source = "#version 130\n";
	fbo_fragment_source += "in vec2 v_textureCoords;\n";
	fbo_fragment_source += "in vec4 v_color;\n";
	fbo_fragment_source += "in vec4 v_position;\n";
	fbo_fragment_source += "uniform sampler2D u_colorMap;\n";
	fbo_fragment_source += "uniform sampler2D u_depthMap;\n";
	fbo_fragment_source += "out vec4 fragment_color;\n";
	fbo_fragment_source += "void main(void)\n";
	fbo_fragment_source += "{\n";
	fbo_fragment_source += "vec4 color = texture2D( u_colorMap , v_textureCoords );\n";
	fbo_fragment_source += "vec4 depth = texture2D( u_depthMap , v_textureCoords );\n";
	fbo_fragment_source += "fragment_color = v_color * color;\n";
	fbo_fragment_source += "}\n";

	std::string fbo_vertex_source = "#version 130\n";
	fbo_vertex_source += "in vec2 a_textureCoords;\n";
	fbo_vertex_source += "in vec3 a_position;\n";
	fbo_vertex_source += "in vec4 a_color;\n";
	fbo_vertex_source += "out vec2 v_textureCoords;\n";
	fbo_vertex_source += "out vec4 v_color;\n";
	fbo_vertex_source += "out vec3 v_position;\n";
	fbo_vertex_source += "uniform mat4 u_worldToClipMatrix;\n";
	fbo_vertex_source += "void main(void)\n";
	fbo_vertex_source += "{\n";
	fbo_vertex_source += "vec4 clipPosition = u_worldToClipMatrix * vec4(a_position, 1.0);\n";
	fbo_vertex_source += "v_color = a_color;\n";
	fbo_vertex_source += "v_textureCoords = a_textureCoords;\n";
	fbo_vertex_source += "v_position = clipPosition.xyz;\n";
	fbo_vertex_source += "gl_Position = clipPosition;\n";
	fbo_vertex_source += "}\n";

	fbo_sp.fragment = new OpenGLShader(FRAGMENT_SHADER, fbo_fragment_source.c_str());
	fbo_sp.vertex = new OpenGLShader(VERTEX_SHADER, fbo_vertex_source.c_str());

	FBO_MATERIAL = new Material(fbo_sp);
}
